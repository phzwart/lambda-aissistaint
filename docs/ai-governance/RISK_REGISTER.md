...
| AI-R5 | LiteLLM secret alias misuse | Medium | High | Alias namespace is constrained to `aissistaint-...-(high|medium|low)` and secret refs must match aliases | Add broker-policy tests and audit denied alias requests |
